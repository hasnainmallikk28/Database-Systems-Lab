...
## 📁 Files Included
* `2024-SE-37-Lab10-StringFunctions.sql`: A fully self-contained script featuring the schema initialization, sample data insertion, and all 12 string manipulation queries.
